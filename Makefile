...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Tue Jan 5 23:23:30 2010
# Project:  LPub.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.6/mkspecs/macx-g++42 -macx -o Makefile LPub.pro
#############################################################################
...
INCPATH       = -I/usr/local/Qt4.6/mkspecs/macx-g++42 -I. -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/usr/include -I. -Imoc -I. -F/Library/Frameworks
LINK          = g++-4.2
...
Makefile: LPub.pro  /usr/local/Qt4.6/mkspecs/macx-g++42/qmake.conf /usr/local/Qt4.6/mkspecs/common/unix.conf \
		/usr/local/Qt4.6/mkspecs/common/mac.conf \
		/usr/local/Qt4.6/mkspecs/common/mac-g++.conf \
		/usr/local/Qt4.6/mkspecs/qconfig.pri \
		/usr/local/Qt4.6/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -spec /usr/local/Qt4.6/mkspecs/macx-g++42 -macx -o Makefile LPub.pro
...
LPub.app/Contents/Info.plist: 
	...
	@sed -e "s,@ICON@,LPub.icns,g" -e "s,@EXECUTABLE@,LPub,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.6/mkspecs/macx-g++42/Info.plist.app >LPub.app/Contents/Info.plist
