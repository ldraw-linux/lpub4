...
# Generated by qmake (2.01a) (Qt 4.5.1) on: Fri Nov 26 12:14:58 2010
# Project:  lpub.pro
# Template: app
# Command: c:\Qt\2009.02\qt\bin\qmake.exe -spec ..\..\..\Qt\2009.02\qt\mkspecs\win32-g++ -win32 CONFIG+=release -o Makefile lpub.pro
#############################################################################
...
Makefile: lpub.pro  ../../../Qt/2009.02/qt/mkspecs/win32-g++/qmake.conf ../../../Qt/2009.02/qt/mkspecs/qconfig.pri \
		...
		../../../Qt/2009.02/qt/mkspecs/features/release.prf \
		...
		c:/Qt/2009.02/qt/lib/qtmain.prl
	$(QMAKE) -spec ..\..\..\Qt\2009.02\qt\mkspecs\win32-g++ -win32 CONFIG+=release -o Makefile lpub.pro
...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Mon Sep 5 16:31:54 2011
# Project:  LPub.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.7/mkspecs/macx-g++ CONFIG+=release -o Makefile LPub.pro
#############################################################################
...
INCPATH       = -I/usr/local/Qt4.7/mkspecs/macx-g++ -I. -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/usr/include -I. -Imoc -I. -F/Library/Frameworks
LINK          = g++
...
Makefile: LPub.pro  /usr/local/Qt4.7/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
		/usr/local/Qt4.7/mkspecs/common/mac.conf \
		/usr/local/Qt4.7/mkspecs/common/mac-g++.conf \
		/usr/local/Qt4.7/mkspecs/qconfig.pri \
		/usr/local/Qt4.7/mkspecs/modules/qt_webkit_version.pri \
	...
	$(QMAKE) -spec /usr/local/Qt4.7/mkspecs/macx-g++ CONFIG+=release -o Makefile LPub.pro
...
LPub.app/Contents/Info.plist: 
	...
	@sed -e "s,@ICON@,LPub.icns,g" -e "s,@EXECUTABLE@,LPub,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.7/mkspecs/macx-g++/Info.plist.app >LPub.app/Contents/Info.plist
